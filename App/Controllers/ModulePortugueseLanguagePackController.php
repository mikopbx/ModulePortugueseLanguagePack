...
namespace Modules\ModulePortugueseLanguagePack\App\Controllers;

use MikoPBX\AdminCabinet\Controllers\BaseController;
use MikoPBX\Modules\PbxExtensionUtils;

/**
 * ModulePortugueseLanguagePackController
 *
 * Controller for Portuguese Language Pack module information page
 */
class ModulePortugueseLanguagePackController extends BaseController
{
    private string $moduleUniqueID = 'ModulePortugueseLanguagePack';
    ...
    public function indexAction(): void
    {
        ...
        // Count sound files
        $soundsDir = $this->moduleDir . '/Sounds/pt-pt';
        $soundFileCount = 0;
        if (is_dir($soundsDir)) {
        ...
        $messagesDir = $this->moduleDir . '/Messages/pt';
        ...
        $footer->addJs("js/cache/{$this->moduleUniqueID}/module-portuguese-language-pack-sounds-api.js", true);
        $footer->addJs("js/cache/{$this->moduleUniqueID}/module-portuguese-language-pack-progress.js", true);
    ...
    public function soundsAction(): void
    {
        ...
        $footer->addJs("js/cache/{$this->moduleUniqueID}/module-portuguese-language-pack-sounds-api.js", true);
        $footer->addJs("js/cache/{$this->moduleUniqueID}/module-portuguese-language-pack-sounds-index.js", true);
