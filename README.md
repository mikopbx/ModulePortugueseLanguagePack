...
Complete Portuguese language pack for MikoPBX including UI translations and voice prompts.

## What's Included

- **Voice Prompts**: Portuguese voice prompts for system menus, greetings, and notifications
- **UI Translations**: Complete Portuguese translation of MikoPBX admin interface

## Installation

1. Download and install the module from MikoPBX Marketplace
2. Enable the module in **Modules** section
3. Go to **General Settings** and select Portuguese (Português) as the system language
