...
namespace Modules\ModulePortugueseLanguagePack\Lib;

use MikoPBX\Modules\Config\ConfigClass;
use Modules\ModulePortugueseLanguagePack\Lib\RestAPI\Controllers\SoundsController;

/**
 * PortugueseLanguagePackConf
 *
 * Wires the per-module REST endpoints (sounds inventory + conversion progress).
 */
class PortugueseLanguagePackConf extends ConfigClass
{
    public const string ROUTE_PREFIX = '/pbxcore/api/v3/module-portuguese-language-pack';
