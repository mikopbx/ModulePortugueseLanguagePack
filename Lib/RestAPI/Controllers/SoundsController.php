...
namespace Modules\ModulePortugueseLanguagePack\Lib\RestAPI\Controllers;
 ...
 *   GET /pbxcore/api/v3/module-portuguese-language-pack/sounds
 *   GET /pbxcore/api/v3/module-portuguese-language-pack/sounds/progress
 */
class SoundsController extends ModulesControllerBase
{
    private const string MODULE_UNIQUE_ID = 'ModulePortugueseLanguagePack';
